...
public class ApiExplorer {
    public static void main(String[] args) throws IOException {
        StringBuilder urlBuilder = new StringBuilder("http://oepnapi.data.go.kr/openapi/service/rest/Covid19/getCovid19SidolnfStateJson"); /*URL*/
        urlBuilder.append("?" + URLEncoder.encode("ServiceKey","UTF-8") + "=aXKNx6Iad5zC8azKYxdI%2FmToJUS7gMxGclRvveriSE0eMGPnWcqlflugSPQm6urgo12sa65hnRVHMryBPryNMA%3D%3D"); /*Service Key*/
